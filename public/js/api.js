...
export const api = {
  ...
  dymoSettings: () => request('/settings/dymo'),
  updateDymoSettings: (enabled) => request('/settings/dymo', { method: 'PUT', headers: { 'Content-Type': 'application/json' }, body: JSON.stringify({ enabled: !!enabled }) }),
