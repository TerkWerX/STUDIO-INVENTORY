...
const sampleItems = [
  ...
  { name: 'Yamaha FG830', common_name: 'Practice Acoustic', category: 'Guitar', brand: 'Yamaha', model: 'FG830', serial_number: 'H7T0123456', year: '2020', purchase_date: '2020-08-10', purchase_price: 339, replacement_value: 399, replacement_value_note: 'Current Yamaha retail', condition: 'Good', condition_notes: '', location: 'Practice Area', description: 'Acoustic guitar for lessons and practice.', quantity: 1, update_checks_enabled: 0, tags: ['Lessons'], photos: ['front'] },
