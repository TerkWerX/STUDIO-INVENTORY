...
export function renderReports(items, stats) {
  ...
  return `
    ...
    <div class="btn-group" style="margin-bottom:2rem">
      ...
      <button type="button" class="btn btn-ghost" data-print-page>Print View</button>
    </div>
    ...
    <div class="insurance-item">
      ...
      <div>
        ...
        <p><strong>Location:</strong> ${escapeHtml(item.location)} &nbsp;|&nbsp;
           <strong>Condition:</strong> ${escapeHtml(item.condition)}${former ? ` &nbsp;|&nbsp; <strong>${escapeHtml(status)}</strong> ${escapeHtml(item.disposition_date || '')}` : ''}</p>
...
export function renderInsurance(items) {
  ...
  return `
    ...
    <div class="btn-group" style="margin-bottom:2rem">
      ...
      <button type="button" class="btn btn-ghost" data-print-page>Print</button>
    </div>
